...
import (
	...
	"github.com/ThomasVNN/go-base/metrics"
	"github.com/ThomasVNN/go-base/metrics/generic"
	"github.com/ThomasVNN/go-base/metrics/internal/lv"
	"github.com/ThomasVNN/go-base/metrics/internal/ratemap"
	"github.com/ThomasVNN/go-base/util/conn"
)
...
func New(prefix string, logger log.Logger, lvs ...string) *Influxstatsd {
	...
	return &Influxstatsd{
		...
		gauges:     map[string]*gaugeNode{}, // https://github.com/ThomasVNN/go-base/pull/588
		timings:    lv.NewSpace(),
